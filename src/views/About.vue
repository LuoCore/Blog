    ...
    <main class="container-fluid px-0">
        ...
        <section class="row g-0">
            ...
            <div class="col-md-6 px-3 px-md-5 py-5">
                <div class="mx-auto py-lg-5" style="max-width: 35rem;">
                    ...
                    <router-link to="/about/CRM" class="btn btn-primary btn-shadow">让LuoCOre来助你成功</router-link>
                </div>
            </div>
        </section>
        ...
        <section class="row g-0">
            ...
            <div class="col-md-6 px-3 px-md-5 py-5 order-md-1">
                <div class="mx-auto py-lg-5" style="max-width: 35rem;">
                    <h2 class="h3 pb-3">
                        <strong>TMS</strong>运输管理系统
                    </h2>
                    <p
                        class="fs-sm pb-3 text-muted"
                    >物流运输管理系统适用于运输公司、各企业下面的运输队等，它主要包括订单管理、配载作业、调度分配、行车管理、GPS车辆定位系统、车辆管理、人员管理、数据报表、基本信息维护、系统管理等模块。该系统对车辆、驾驶员、线路等进行全面详细的统计考核，能大大提高运作效率，降低运输成本，使您在激烈的市场竞争中处于领先优势。</p>
                    <router-link to="/about/TMS" class="btn btn-accent btn-shadow" >您运输中的航空母舰</router-link>
                </div>
            </div>
        </section>
        ...
        <section class="row g-0">
            ...
            <div class="col-md-6 px-3 px-md-5 py-5 order-md-1">
                <div class="mx-auto py-lg-5" style="max-width: 35rem;">
                    ...
                    <router-link to="/about/CTMS" class="btn btn-warning btn-shadow">LuoCore 集运系统</router-link>
                </div>
            </div>
        </section>
        <hr />
                ...
                <div class="col-lg-4 col-sm-6 mb-grid-gutter">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ps-3">
                            ...
                            <a class="nav-link-style fs-ms text-nowrap" href="LuoCore@hotmail.com">
        ...
        <section class="row g-0">
            ...
            <div class="col-md-6 px-3 px-md-5 py-5 order-md-1">
                <div class="mx-auto py-lg-5" style="max-width: 35rem;">
                    ...
                    <p class="fs-sm text-muted pb-2">如果您想为我们的未来尽一份力，欢迎来给我们投资，我们将尽最大努力为你提供最好的服务！</p>
                    <form class="needs-validation row g-4" method="post" novalidate>
                        <div class="col-sm-6">
                            <input class="form-control" type="text" placeholder="您的名字" required />
                        </div>
                        <div class="col-sm-6">
                            <input class="form-control" type="email" placeholder="您的联系方式" required />
                        </div>
                        <div class="col-12">
                            <textarea
                                class="form-control"
                                rows="4"
                                placeholder="您有什么想对我说的"
                                required
                            ></textarea>
                        </div>
                        <div class="col-12">

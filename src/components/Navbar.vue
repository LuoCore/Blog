                ...
                <div class="collapse navbar-collapse me-auto order-lg-2" id="navbarCollapse">
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                <li class="dropdown position-static mb-0">
                                    ...
                                    >
                                        <span class="d-block text-heading">时尚店铺 v.1</span>
                                        <small class="d-block text-muted">经典店铺布局</small>
                                    </a>
                                    <div class="dropdown-menu h-100 animation-none mt-0 p-3">
                                        ...
                                        >
                                            <img
                                                src="../assets/images/home/preview/th01.jpg"
                                                alt="时尚店铺 v.1"
                                            />
                                        </a>
                                    </div>
                                ...
                                <li class="dropdown position-static mb-0">
                                    ...
                                    >
                                        <span class="d-block text-heading">电子产品商店</span>
                                        <small class="d-block text-muted">滑动 + 促销宣传</small>
                                    </a>
                                    <div class="dropdown-menu h-100 animation-none mt-0 p-3">
                                        <a
                                            class="d-block"
                                        ...
                                        >
                                            <img
                                                src="../assets/images/home/preview/th03.jpg"
                                ...
                                <li class="dropdown position-static mb-0">
                                    ...
                                    >
                                        <span class="d-block text-heading">市场</span>
                                        <small class="d-block text-muted">多供应商、数码产品</small>
                                    </a>
                                    <div class="dropdown-menu h-100 animation-none mt-0 p-3">
                                        <a
                                            class="d-block"
                                        ...
                                        >
                                            <img
                                                src="../assets/images/home/preview/th04.jpg"
                                                alt="Marketplace"
                                            />
                                        </a>
                                    </div>
                                ...
                                <li class="dropdown position-static mb-0">
                                    ...
                                    >
                                        <span class="d-block text-heading">杂货店</span>
                                        <small class="d-block text-muted">全宽+侧菜单</small>
                                    </a>
                                    <div class="dropdown-menu h-100 animation-none mt-0 p-3">
                                        <a
                                            class="d-block"
                                        ...
                                        >
                                            <img
                                                src="../assets/images/home/preview/th06.jpg"
                                                alt="Grocery Store"
                                            />
                                        </a>
                                    </div>
                                ...
                                <li class="dropdown position-static mb-0">
                                    ...
                                    >
                                        <span class="d-block text-heading">食品外卖服务</span>
                                        <small class="d-block text-muted">食物 & 饮料交付</small>
                                    </a>
                                    <div class="dropdown-menu h-100 animation-none mt-0 p-3">
                                        <a
                                            class="d-block"
                                        ...
                                        >
                                            <img
                                                src="../assets/images/home/preview/th07.jpg"
                                ...
                                <li class="dropdown position-static mb-0">
                                    ...
                                    >
                                        <span class="d-block text-heading">时尚商店 v.2</span>
                                        <small class="d-block text-muted">滑块 +有特色的类别</small>
                                    </a>
                                    <div class="dropdown-menu h-100 animation-none mt-0 p-3">
                                        <a
                                            class="d-block"
                                        ...
                                        >
                                            <img
                                                src="../assets/images/home/preview/th02.jpg"
                                ...
                                <li class="dropdown position-static mb-0">
                                    <a class="dropdown-item py-2" href="home-single-store.html">
                                        <span class="d-block text-heading">单一产品商店</span>
                                        <small class="d-block text-muted">单一产品/单一品牌</small>
                                    </a>
                                    <div class="dropdown-menu h-100 animation-none mt-0 p-3">
                                        <a
                                            class="d-block"
                                        ...
                                        >
                                            <img
                                                src="../assets/images/home/preview/th05.jpg"
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a class="dropdown-item" href="account-orders.html">订单历史</a>
                                        </li>
                                        <li>
                                            <a
                                                class="dropdown-item"
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li>
                                            <a class="dropdown-item" href="dashboard-sales.html">销售量</a>
                                        </li>
                                        <li>
                                            <a
                                                class="dropdown-item"
                                ...
                                <li>
                                    <a class="dropdown-item" href="account-signin.html">登录注册</a>
                                </li>
                                <li>
                                    <a
                                        class="dropdown-item"
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li class="dropdown">
                                    <a class="dropdown-item dropdown-toggle" href="#">导航条变异</a>
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a
                                                class="dropdown-item"
                                        ...
                                        <li>
                                            <a class="dropdown-item" href="home-marketplace.html">市场</a>
                                        </li>
                                        <li>
                                            <a
                                                class="dropdown-item"
                                ...
                                <li>
                                    <a class="dropdown-item" href="contacts.html">联系人</a>
                                </li>
                                <li class="dropdown">
                                    <a
                                        class="dropdown-item dropdown-toggle"
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a class="dropdown-item" href="help-topics.html">帮助主题</a>
                                        </li>
                                        <li>
                                            <a
                                                class="dropdown-item"
                            ...
                            <ul class="dropdown-menu">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li>
                                            <a class="dropdown-item" href="blog-list.html">列表没有侧边栏</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li>
                                            <a class="dropdown-item" href="blog-grid.html">网格没有侧边栏</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li>
                                            <a class="dropdown-item" href="blog-single.html">文章没有侧边栏</a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
                                ...
                                <li>
                                    <a class="dropdown-item" href="docs/dev-setup.html">
                                        <div class="d-flex">
                                            ...
                                            <div class="ms-2">
                                                <span class="d-block text-heading">文档</span>
                                                <small class="d-block text-muted">启动定制</small>
                                            </div>
                                        </div>
                                    </a>
                                </li>
                                    ...
                                    <a class="dropdown-item" href="components/typography.html">
                                        <div class="d-flex">
                                            ...
                                            <div class="ms-2">
                                                ...
                                                <small class="d-block text-muted">更快的页面构建</small>
                                            </div>
                                        </div>
                                    </a>
                                </li>
                                    ...
                                    <a class="dropdown-item" href="docs/changelog.html">
                                        <div class="d-flex">
                                            ...
                                            <div class="ms-2">
                                                ...
                                                <small class="d-block text-muted">定期更新</small>
                                            </div>
                                        </div>
                                    </a>
                                </li>
                                ...
                                <li>
                                    <a class="dropdown-item" href="mailto:support@createx.studio">
                                        <div class="d-flex">
                                            ...
                                            <div class="ms-2">
                                                <span class="d-block text-heading">支持</span>
                                                <small
